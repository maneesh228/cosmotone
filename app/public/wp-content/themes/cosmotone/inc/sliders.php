...
function cosmotone_slider_admin_assets( $hook ) {
	...
	wp_enqueue_media();
	wp_add_inline_style( 'common', '.cosmotone-slider-editor-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.cosmotone-slider-editor-grid>label,.cosmotone-slider-editor-grid>div{display:flex;flex-direction:column;gap:6px;min-width:0}.cosmotone-slider-editor-grid>label>span,.cosmotone-slider-editor .field-label{font-weight:600}.cosmotone-slider-editor-grid>label>input,.cosmotone-slider-editor-grid>label>select,.cosmotone-slider-editor-grid .media-row>input{width:100%}.cosmotone-slider-editor-grid .wide{grid-column:1/-1}.cosmotone-slider-editor .wp-editor-wrap{display:block;width:100%}.cosmotone-slider-editor .media-row{display:flex;gap:8px}.cosmotone-slider-editor .media-row .button{white-space:nowrap}.cosmotone-slider-editor #cosmotone-slider-preview{display:flex;align-items:center;justify-content:center;min-height:120px;background:#f0f0f1}.cosmotone-slider-editor #cosmotone-slider-preview img,.cosmotone-slider-editor #cosmotone-slider-preview video{max-width:100%;max-height:220px}@media(max-width:782px){.cosmotone-slider-editor-grid{grid-template-columns:1fr}.cosmotone-slider-editor-grid .wide{grid-column:auto}}' );
}
